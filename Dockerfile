...
LABEL maintainer="Ishtiyaq Husain <ishtiyq.husain@gmail.com>" Description="This is nginx web server with Google brotli compression" Vendor="Ishtiyaq Husain" Version="${NGINX_VERSION}"
